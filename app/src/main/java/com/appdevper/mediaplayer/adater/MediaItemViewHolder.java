...
public class MediaItemViewHolder {
    ...
    static View setupView(Activity activity, View convertView, ViewGroup parent, MediaMetadata item, int state) {
        ...
        holder.mTitleView.setText(item.getString(MediaMetadata.METADATA_KEY_TITLE));
        holder.mDescriptionView.setText(item.getString(MediaMetadata.METADATA_KEY_ALBUM));
