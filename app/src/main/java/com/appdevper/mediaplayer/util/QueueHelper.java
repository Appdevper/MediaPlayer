...
public class QueueHelper {
    ...
    public static List<MediaSession.QueueItem> getPlayingQueue(String mediaId, MusicProvider musicProvider) {
        ...
        Iterable<MediaMetadata> tracks = musicProvider.getAllMusic();
    ...
    private static List<MediaSession.QueueItem> convertToQueue(Iterable<MediaMetadata> tracks) {
        ...
        for (MediaMetadata track : tracks) {
            ...
            MediaMetadata trackCopy = new MediaMetadata.Builder(track).putString(MediaMetadata.METADATA_KEY_MEDIA_ID, track.getDescription().getMediaId())
                    .build();
